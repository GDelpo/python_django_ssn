    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cronograma', models.CharField(help_text='Periodo del cronograma (YYYY-MM)', max_length=7, validators=[django.core.validators.MinLengthValidator(7)])),
                ('operaciones', models.JSONField(default=list, help_text='Lista con todas las operaciones en formato JSON')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_especie', models.CharField(choices=[('TP', 'Títulos Públicos'), ('ON', 'Obligaciones Negociables'), ('FC', 'Fondos Comunes de Inversión'), ('FF', 'Fideicomisos Financieros'), ('AC', 'Acciones'), ('OP', 'Otras Inversiones')], help_text='Tipo de especie (2 caracteres)', max_length=2)),
                ('codigo_especie', models.CharField(help_text='Código de la especie', max_length=20)),
                ('cant_especies', models.DecimalField(decimal_places=6, help_text='Cantidad de especies (valor nominal): 14 enteros + 6 decimales para FCI, 14 enteros para otras inversiones', max_digits=20)),
                ...
                ('comprobante', models.FileField(blank=True, help_text='Adjunta el comprobante (PDF, imagen, etc.)', null=True, upload_to=operaciones.helpers.file_utils.comprobante_upload_path, validators=[operaciones.helpers.file_utils.validate_comprobante_file])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_valuacion', models.CharField(choices=[('T', 'Técnico'), ('V', 'Mercado')], help_text='Tipo de valuación (T -> Técnico | V -> Mercado)', max_length=1)),
                ('comprobante', models.FileField(blank=True, help_text='Adjunta el comprobante (PDF, imagen, etc.)', null=True, upload_to=operaciones.helpers.file_utils.comprobante_upload_path, validators=[operaciones.helpers.file_utils.validate_comprobante_file])),
                ('precio_compra', models.DecimalField(decimal_places=2, help_text='Precio de compra', max_digits=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalle_a', models.OneToOneField(help_text='Datos de la operación A', on_delete=django.db.models.deletion.CASCADE, related_name='canje_operacion_a', to='operaciones.detalleoperacioncanje')),
                ('detalle_b', models.OneToOneField(help_text='Datos de la operación B', on_delete=django.db.models.deletion.CASCADE, related_name='canje_operacion_b', to='operaciones.detalleoperacioncanje')),
            ],
            options={
                'verbose_name': 'Canje',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_pf', models.CharField(help_text='Tipo de plazo fijo', max_length=50)),
                ...
                ('codigo_afectacion', models.CharField(help_text='Código de afectación', max_length=3)),
                ('tipo_tasa', models.CharField(help_text='Tipo de tasa', max_length=50)),
                ('tasa', models.FloatField(help_text='Valor de la tasa')),
                ('titulo_deuda', models.BooleanField(help_text='Indica si es título de deuda')),
                ('codigo_titulo', models.CharField(help_text='Código del título', max_length=50)),
                ('comprobante', models.FileField(blank=True, help_text='Adjunta el comprobante (PDF, imagen, etc.)', null=True, upload_to=operaciones.helpers.file_utils.comprobante_upload_path)),
